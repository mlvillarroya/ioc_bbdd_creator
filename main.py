...
def create_clients(client_number):
    ...
    for i in range (client_number):
        ...
        email_data.append(full_name.split(' ')[0][:3].lower() + full_name.split(' ')[1][:3].lower() + str(aux_functs.random_num(999)) + 'gmail.com')
    ...
    table.insert_data([first_name_data,last_name_data,address_data,email_data,id_city_data,phone_data])
    table.export_into_file()
